...
/**
 * TCP/IP client interface, client endpoint of {@link TcpNetEndpoint}.
 * <p>
 * A {@link TcpNetClient2} implementation should support following types of handler:
 * <ul>
 *     <li>
 ...
 */
@ThreadSafe
public interface TcpNetClient2 extends TcpNetEndpoint {

    /**
     * Returns new builder of {@link TcpNetClient2}. The returned builder is based on {@link Socket}.
     *
     * @return new builder
     */
    ...
    /**
     * Builder for {@link TcpNetClient2}, based on {@link Socket}.
     */
    class Builder {
        ...
        public Builder addChannelHandlers(Iterable<GekTcpChannelHandler<?>> channelHandlers) {
            CollectKit.addAll(this.channelHandlers, channelHandlers);
            return this;
        }
         ...
         * @return built client
         */
        public TcpNetClient2 build() {
            return new SocketTcpClient(this);
        }

        private static final class SocketTcpClient implements TcpNetClient2 {
            ...
            private void compactBuffer(ChannelImpl channel) {
                channel.buffer = SocketBack.compact(channel.buffer, bufferGenerator);
            }

            private void compactBuffer(ChannelImpl channel, byte[] newBytes) {
                channel.buffer = SocketBack.compact(channel.buffer, newBytes, bufferGenerator);
            }
