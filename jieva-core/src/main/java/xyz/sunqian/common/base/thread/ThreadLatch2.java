 ...
 * <p>
 * {@link ThreadLatch2} can send signals to itself by {@link #signal(Object)}. How to handle the signals is determined by
 ...
 * {@link ThreadLatch2}. It is produced by {@link #waiter()}, and be shared the state with the {@link ThreadLatch2}.
 *
 * @param <T> the type of the signal object
 * @author sunqian
 */
@ThreadSafe
public interface ThreadLatch2<T> {

    /**
     * Returns a new {@link ThreadLatch2}. The signal will be ignored.
     *
     * @param <T> the type of the signal object
     * @return a new {@link ThreadLatch2}
     */
    ...
    /**
     * Returns a new {@link ThreadLatch2} with the specified signal consumer, the signal will be consumed by that
    ...
    /**
     * This interface is a narrowed interface of the {@link ThreadLatch2}, which only has waiting methods and signal
     * methods, without latch methods. A {@link Waiter} is produced from a {@link ThreadLatch2} which as the host and
    ...
    interface Waiter<T> {
        ...
        /**
         * Sends a signal to the {@link ThreadLatch2} where it was produced.
         *
         * @param o the signal object
         */
        void signal(@Nullable T o);
    ...
    /**
     * State of the {@link ThreadLatch2}.
     */
    enum State {
