 ...
 * {@link #mapProperty(Object, Type, Type, DataProperty, MappingOptions)}.
 *
 * @author fredsuvn
 * @see Handler#map(Object, Type, Type, Mapper, MappingOptions)
 * @see Handler#mapProperty(Object, Type, Type, DataProperty, Mapper, MappingOptions)
 */
@ThreadSafe
public interface Mapper {
     ...
     *     </li>
     * </ul>
     * This method is equivalent to ({@link #mapProperty(Object, Type, Type, DataProperty, MappingOptions)}):
     * <pre>
     ...
     * </ul>
     * In the default implementation, this method will invoke
     * {@link Handler#mapProperty(Object, Type, Type, DataProperty, Mapper, MappingOptions)} for each handler in
