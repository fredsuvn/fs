...
final class CharReaderXImpl {

    static @Nonnull CharReaderX of(@Nonnull Reader source) {
        return new CharStreamReaderX(source);
    }

    static @Nonnull CharReaderX of(char @Nonnull [] source, int offset, int length) throws IndexOutOfBoundsException {
        return new CharArrayReaderX(source, offset, length);
    }

    static @Nonnull CharReaderX of(@Nonnull CharSequence source, int start, int end) throws IndexOutOfBoundsException {
        return new CharSequenceReaderX(source, start, end);
    }

    static @Nonnull CharReaderX of(@Nonnull CharBuffer source) {
        return new CharBufferReaderX(source);
    }
    ...
    private static final class CharStreamReaderX implements CharReaderX {

        private final @Nonnull Reader source;

        CharStreamReaderX(@Nonnull Reader source) {
            this.source = source;
        }
    ...
    private static final class CharArrayReaderX implements CharReaderX {
        ...
        CharArrayReaderX(char @Nonnull [] source, int offset, int length) throws IndexOutOfBoundsException {
    ...
    private static final class CharSequenceReaderX implements CharReaderX {
        ...
        CharSequenceReaderX(@Nonnull CharSequence source, int start, int end) throws IndexOutOfBoundsException {
    ...
    private static final class CharBufferReaderX implements CharReaderX {

        private final @Nonnull CharBuffer source;

        CharBufferReaderX(@Nonnull CharBuffer source) {
            this.source = source;
        }
