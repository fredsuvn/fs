...
public interface ByteEncoder {
    ...
    /**
     * Returns a new {@link ByteEncoder} whose data source is the specified input stream.
     *
    ...
    /**
     * Returns a new {@link ByteEncoder} whose data source is the specified array.
     *
    ...
    /**
     * Returns a new {@link ByteEncoder} whose data source is a specified length of data from the specified array,
     * starting at the specified offset.
     *
     * @param src the specified array
     * @param off the specified offset
     * @param len the specified length
     * @return a new {@link ByteEncoder} whose data source is a specified length of data from the specified array,
     * starting at the specified offset
    ...
    /**
     * Returns a new {@link ByteEncoder} whose data source is the specified buffer.
     *
    ...
    /**
     * Returns a new {@link ByteEncoder} whose data source is the specified {@link ByteReader}.
     *
     ...
     * <p>
     * This is an optional setting method. {@link ByteEncoder} also provides some specific handler wrappers such as:
     ...
     * <pre>{@code
     * return encodeTo(IOKit.nullOutputStream());
     * }</pre>
     *
     ...
     * bytes read. If reaches the end of the data source and no data is read, returns {@code -1}.
     * <p>
     ...
     * and returns the actual number of bytes read. If reaches the end of the data source and no data is read, returns
     * {@code -1}.
     * <p>
     * The positions of the data source and destination, if any, will be incremented by the actual read and write
     * numbers.
    ...
    /**
     * Returns this {@link ByteEncoder} as an {@link InputStream}. The status and data source of this encoder are shared
     * with the returned {@link InputStream}, and the returned {@link InputStream}'s content represents the encoding
     * result.
     * <p>
     ...
     * This is a terminal method.
     *
     * @return this {@link ByteEncoder} as an {@link InputStream}
     */
    @Nonnull
     ...
     */
    default @Nonnull CharEncoder toCharEncoder(@Nonnull Charset charset) {
