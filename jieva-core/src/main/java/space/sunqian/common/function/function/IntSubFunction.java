package space.sunqian.common.function.function;

/**
 * Represents an operation that accepts an object and the specified range, and returns the sub-portion of the specified
 * range of the object.
 * <p>
 * This is an int version of {@link SubFunction} whose functional method is {@link #apply(Object, int, int)}.
 *
 ...
 */
@FunctionalInterface
public interface IntSubFunction<T, R> {
