...
/**
 * This interface represents the schema of non-map object, parsed by a {@link ObjectParser}, and provides information
 ...
 * parsing properties are defined by the implementation of {@link ObjectParser}, rather than a public rules.
 * <p>
...
public interface ObjectSchema extends DataSchema {
    ...
    /**
     * Parse the given type to {@link ObjectSchema} using {@link ObjectParser#defaultParser()}.
     * <p>
    ...
    /**
     * Returns the {@link ObjectParser} of this {@link ObjectSchema}.
     *
     * @return the {@link ObjectParser} of this {@link ObjectSchema}
     */
    @Nonnull
    ObjectParser parser();
