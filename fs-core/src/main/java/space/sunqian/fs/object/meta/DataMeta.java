 ...
 * <p>
 * A data object may be an instance of {@link Map} which can be introspected by {@link MapMetaIntrospector}, or a
 * non-map object which can be introspected by {@link ObjectMetaIntrospector}.
 *
 * @author sunqian
 */
@Immutable
