...
// import space.sunqian.fs.data.json.JsonBack;
// import space.sunqian.fs.data.json.JsonDataException;
// import space.sunqian.fs.data.json.JsonMap;
// import space.sunqian.fs.data.json.JsonNull;
// import space.sunqian.fs.data.json.JsonOutputableData;
//
...
//  *     <li>{@link DataList} to JSON array;</li>
...
//  * @author sunqian
//  */
// public interface DataList extends List<Object>, JsonOutputableData {
//
//     /**
...
//      */
//     default @Nullable DataList getArray(int index) throws IndexOutOfBoundsException, JsonDataException {
//         Object value = get(index);
//         if (JsonBack.isNullValue(value)) {
//             return null;
//         }
